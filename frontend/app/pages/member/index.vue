...
.msg-bubble { max-width: 80%; padding: 8px 12px; border-radius: 12px; background: #f1f5f9; }
.msg-bubble--mine { align-self: flex-end; background: #f59e0b; color: #fff; }
.msg-bubble--mine .msg-time { color: rgba(255,255,255,.7); }
.msg-bubble--system { max-width: 100%; background: #ecfdf5; border: 1px solid #86efac; text-align: center; align-self: center; }
