...
const consultations = ref<ConsultationForm[]>([
  {
    ...
    estimateMin: 250,
    estimateMax: 320,
    aiNote: '🤖 AI 標註：趕飛機旅客 / 建議優先派車 / 預估車程 18 分鐘',
    status: 'pending',
    createdAt: '2024-07-30 14:02',
  },
  {
    id: 'c-2',
    feedbackNo: 'FB202407300002',
    contactName: '林奶奶',
    contactPhone: '0922-***-789',
    pickup: '台大醫院門診大樓',
    destination: '新北市中和區景安路 88 號',
    carType: 'accessible',
    mode: 'instant',
    passengers: 1,
    estimateMin: 280,
    ...
    status: 'pending',
    createdAt: '2024-07-30 14:15',
  },
  {
    id: 'c-3',
    feedbackNo: 'FB202407300003',
    contactName: '張小姐',
    contactPhone: '0933-***-012',
    pickup: '信義威秀影城',
    destination: '內湖科技園區瑞光路 300 號',
    carType: 'sedan',
    mode: 'instant',
    passengers: 1,
    estimateMin: 250,
    ...
    status: 'pending',
    createdAt: '2024-07-30 22:30',
  },
  {
    id: 'c-4',
    feedbackNo: 'FB202407300004',
    contactName: '王經理',
    contactPhone: '0955-***-321',
    pickup: '台北 101 大樓 B1',
    destination: '桃園國際機場 T2',
    carType: 'van',
    mode: 'scheduled',
    scheduledTime: '2024-07-31T08:00',
    passengers: 3,
    estimateMin: 900,
    estimateMax: 1100,
    aiNote: '🤖 AI 標註：商務接送 / 大型行李 / 預約明早 08:00',
    status: 'pending',
    createdAt: '2024-07-30 18:45',
  },
])
...
const orders = ref<Order[]>([
  {
    ...
    finalAmount: 320,
    status: 'in_transit',
    orderTime: '2024-07-30 13:50',
    serviceTime: '2024-07-30 14:02',
  },
  {
    id: 'o-2',
    orderNo: 'TR-2024-0002',
    contactName: '許小姐',
    contactPhone: '0911-***-555',
    pickup: '西門町',
    destination: '天母忠誠路 200 號',
    carType: 'sedan',
    passengers: 2,
    assignedDriver: '張國榮',
...
function resetDemo() {
  ...
  orders.value = [
    {
      id: 'o-1', orderNo: 'TR-2024-0001', contactName: '劉先生', contactPhone: '0966-***-888',
      pickup: '南港展覽館', destination: '板橋車站', carType: 'sedan', passengers: 1,
      assignedDriver: '王志明', assignedPlate: 'DEF-5678', eta: 12, finalAmount: 320,
      status: 'in_transit', orderTime: '2024-07-30 13:50', serviceTime: '2024-07-30 14:02',
    },
    {
      id: 'o-2', orderNo: 'TR-2024-0002', contactName: '許小姐', contactPhone: '0911-***-555',
      pickup: '西門町', destination: '天母忠誠路 200 號', carType: 'sedan', passengers: 2,
      assignedDriver: '張國榮', assignedPlate: 'PQR-2468', eta: 5, finalAmount: 380,
      status: 'dispatched', orderTime: '2024-07-30 14:20',
    },
  ]
  drivers.value = [
    { id: 'd-1', name: '李大衛', plate: 'ABC-1234', vehicleType: 'Toyota Camry', rating: 4.9, status: 'idle', currentLocation: '中正區', completedToday: 8 },
